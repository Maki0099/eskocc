...
- Podmínky vzdálenosti a času se z podmínek výběru odstraní — místo toho funkce spočítá rozdíly a příznak `likely_duplicate` (shoda vzdálenosti ≤ 500 m a času ≤ 360 s), aby bylo poznat, která dvojice je téměř jistá duplicita.
